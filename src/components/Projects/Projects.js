        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="AI Book Chat Platform"
              description="An AI-powered platform that transforms static PDFs into real-time conversational experiences. Users can extract text, interact via voice, and access session transcripts."
              ghLink="https://github.com/edenWerke/Bookiefied.git"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Care Pluse"
              description="A healthcare platform for patient registration, appointment scheduling, and medical records management with responsive UI and notifications."
              ghLink="https://github.com/edenWerke/CarePluse.git"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Real-Time Rides & Payments"
              description="A full-stack Uber clone with real-time tracking, driver-rider matching, and secure payments."
              ghLink="https://github.com/edenWerke/Uber-ride.git"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Bankist App"
              description="A finance manager app for checking balance, transactions, transfers, loans, and account management."
              ghLink="https://github.com/edenWerke/BankistApp.git"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Food Recipe"
              description="A recipe app that helps users explore and cook dishes with step-by-step instructions."
              ghLink="https://github.com/edenWerke/food-recipe.git"
            />
          </Col>
